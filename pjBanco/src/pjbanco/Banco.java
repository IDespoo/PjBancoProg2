...
public class Banco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPNuevaCuenta.add(btnAgregarTipoCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, 40, -1));
    ...
    private void btnAgregarMovimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarMovimientoActionPerformed
       ...
       switch (m.getTipoMovimiento()) {
            ...
            case "TRANSFERENCIA":
                ...
                mDestino.setFechaMovimiento(new SimpleDateFormat("dd/MM/yyyy").format(new Date()));
